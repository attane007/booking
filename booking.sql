...
CREATE TABLE `reserve` (
  ...
  `organization` varchar(200) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
INSERT INTO `reserve` (`id_table`, `name_table`, `name`, `tel`, `email`, `status`, `status_pay`, `date_buy`, `seller`, `payment`, `birth_year`, `organization`, `cookie_`, `date_del`) VALUES
